    ...
    <footer className='flex justify-center items-center mb-24'>
      <div className='mx-auto max-w-[1440px] px-6 lg:px-20 3xl:px-0 flex w-full flex-col gap-14'>
        <div className='flex flex-col items-start justify-center gap-[10%] md:flex-row'>
          <Link href='https://fasakinhenry.com' className='mb-10'>
              ...
              <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                {FOOTER_CONTACT_INFO.links.map((link) => (
                  ...
                  >
                    ...
                    <p className='text-[14px] font-semibold whitespace-nowrap text-blue-70'>
                      {link.value}
                    </p>
                  </Link>
                ))}
        ...
        <p className='text-[14px] font-normal w-full text-center text-gray-30'>
