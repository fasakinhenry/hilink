          ...
          <div className='flex items-center justify-between flex-col'>
            <div className='flex w-full flex-col'>
              <div className='flex items-center justify-between w-full'>
                <p className='text-[16px] font-normal text-gray-20'>Destination</p>
                <p className='text-[16px] font-bold text-green-50'>48 min</p>
              </div>
              <p className='text-[20px] font-bold mt-2'>Aguas Calientes</p>
            </div>

            <div className='flex w-full flex-col'>
              <p className='text-[16px] font-normal text-gray-20'>Start track</p>
              <h4 className='text-[20px] font-bold mt-2 whitespace-nowrap'>
                Wonorejo Pasuruan
              </h4>
            </div>
          </div>
