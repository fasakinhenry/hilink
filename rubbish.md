...
/* ---------------------------------------------------
   TAILWIND v4 THEME TOKENS (replaces tailwind.config.js)
---------------------------------------------------- */
@theme {
  /* Colors */
...
/* ---------------------------------------------------
   UTILITIES (unchanged from v3 – still supported)
---------------------------------------------------- */
...
/* Get App */
.get-app {
  @apply max-container relative flex w-full flex-col justify-between gap-32 overflow-hidden 
           bg-green-90 bg-pattern bg-cover bg-center bg-no-repeat px-6 py-12 text-white 
